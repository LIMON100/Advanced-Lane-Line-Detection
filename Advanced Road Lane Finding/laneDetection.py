...
def ransac_drawlane(left_lane_sa, right_lane_sa,frame):
    ...
    #print(calculateDistance(x_1, y_1, x_2, y_2))
    #print(calculateDistance(x_3, y_3, x_4, y_4))

    d1 = calculateDistance(x_1, y_1, x_2, y_2)
    d2 = calculateDistance(x_3, y_3, x_4, y_4)
...
if __name__== "__main__":
    ...
    cap = cv2.VideoCapture('I:/JumpWatts/Dataset/Bike lane/video/g3.mkv')
    while(cap.isOpened()):
        ret, frame = cap.read()
